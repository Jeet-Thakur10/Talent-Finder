class AuthBaseException(Exception):
    ...
    def __init__(
        self, message: str, details: str | None = None, error_code: str | None = None
    ):
...
class InvalidToken(AuthBaseException):
    def __init__(self, details: str | None = None, error_code: str | None = None):
        super().__init__(
            message="Invalid or expired token", details=details, error_code=error_code
        )
...
class UserAlreadyExistsException(AuthBaseException):
    def __init__(self, details: str | None = None):
        super().__init__(
            message="A user with this email already exists", details=details
        )


class InvalidCredentials(AuthBaseException):
    def __init__(self, details: str | None = None):
        super().__init__(message="Invalid email or password", details=details)
